    ...
    <div className="container-layout flex flex-col items-center gap-16 mb-40">
          ...
          >
            ...
            <div className="flex lg:gap-8 gap-2">
              {item.detail.map((detailItem, index) => (
                <div className="flex lg:gap-4 gap-1" key={detailItem.label}>
                  <div>{detailItem.icon}</div>
            ...
            <div className="lg:px-4 lg:py-3 px-2 py-1 w-fit flex items-center gap-2.5 lg:rounded-[0.625rem] rounded-lg bg-primary text-neutral-white font-montserrat">
              <p className="lg:text-body-l text-caption font-bold ">Read Article</p>
      ...
      <div className="bg-light-primary rounded-[1.875rem] w-full flex flex-col justify-center gap-8 items-center text-center px-4 py-20 font-montserrat">
        ...
        <div className="lg:w-155 w-full md:w-104 flex flex-col sm:flex-row gap-4">
            <input type="email" placeholder="Enter your email" className="grow lg:text-body-l text-caption bg-neutral-white border border-neutral-300 p-3 lg:rounded-[1.25rem] rounded-2xl text-neutral-500" />
            <button className="lg:py-3 lg:px-6 p-3 bg-primary text-white rounded-[1.25rem] text-caption lg:text-body-l font-bold">Subscribe</button>
        </div>
        <p className="lg:text-body-m text-caption text-neutral-500">Completely free, no spam, can unsubscribe anytime.</p>
      </div>
    </div>
  );
}

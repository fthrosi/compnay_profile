...
export default function TeamAdd({ onClose, onSuccess }: TeamFormProps) {
  ...
  return (
    <Modal title="Tambah Anggota Team">
          ...
          {preview ? (
            <div className="relative mb-4">
              <img
                src={preview}
                alt="Preview"
                className="w-full h-auto object-cover rounded-lg border-2 border-blue-200"
              />
              <button
                type="button"
                onClick={() => {
